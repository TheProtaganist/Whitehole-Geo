...
import whitehole.theme.FlatCyanLaf;
...
public class Whitehole {
    public static final String NAME = "Whitehole Geo";
    ...
    private static FlatCyanLaf CYAN_THEME;
    ...
    public static void main(String[] args) throws IOException {
        ...
        CYAN_THEME = new FlatCyanLaf();
        
        try {
            // Use cyan theme as default (light blue professional theme)
            UIManager.setLookAndFeel(CYAN_THEME);
        }
        catch (Exception ex) {
        ...
        // Initialize AI object database context
        try {
            whitehole.ai.ObjectDatabaseContext.getInstance().initialize();
            System.out.println("ObjectDatabaseContext initialized successfully");
        } catch (Exception e) {
    ...
    public static void requestUpdateLAF() {
        ...
        if (Settings.getUseDarkMode()) {
            ...
            // Default to cyan theme (light blue professional theme)
            if (UIManager.getLookAndFeel() != CYAN_THEME) {
                next = CYAN_THEME;
            }
        }
